...
namespace DatabaseCalc
{
    public partial class Form1 : Form
    {
        ...
        private void make_ButtonClick(object sender, EventArgs e)
        {
            MessageBox.Show("개발 중 입니다.");   // 이벤트 핸들러 미지정
        }
        private void num_ButtonClick(object sender, EventArgs e)
        {
        ...
        private void singButtonClick(object sender, EventArgs e)
        {
            Button btn = (Button)sender;    // 이벤트가 발생한 객체
        ...
        private void op2_ButtonClick(object sender, EventArgs e)
        {
        ...
        private void op_ButtonClick(object sender, EventArgs e)
        {
            Button btn = (Button)sender;
